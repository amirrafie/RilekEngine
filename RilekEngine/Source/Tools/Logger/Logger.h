...
#define RLK_TRACE(...) ::Rilek::Tools::logger::get_console_logger()->trace(__VA_ARGS__)
#define RLK_INFO(...) ::Rilek::Tools::logger::get_console_logger()->info(__VA_ARGS__)
#define RLK_WARN(...) ::Rilek::Tools::logger::get_console_logger()->warn(__VA_ARGS__)
#define RLK_ERROR(...) ::Rilek::Tools::logger::get_console_logger()->error(__VA_ARGS__)
